          ...
          <Dialog open={aboutOpen} onOpenChange={setAboutOpen}>
            ...
            >
              ...
              <DialogDescription className="pt-1 text-right text-sm leading-8" style={{ color: "#F7FBFF", fontFamily: "Cairo, sans-serif" }}>
                <span>مكنز القضاء والأنظمة والمحاماة فهرس بحثي للروابط والإحالات إلى مواد قانونية وقضائية منشورة في مصادر خارجية، أُعدّ لتيسير الوصول وخدمة الباحثين والقضاة والمحامين. لا يدّعي المكنز ملكية المواد ولا يضمن محتواها أو دقتها أو بقاء روابطها، وتبقى الحقوق لأصحابها.</span>
                <br />
                <br />
