          ...
          <Dialog open={aboutOpen} onOpenChange={setAboutOpen}>
            ...
            >
              ...
              <DialogDescription className="pt-1 text-right text-sm leading-8" style={{ color: "#F7FBFF", fontFamily: "Cairo, sans-serif" }}>
                مكنز القضاء والأنظمة والمحاماة فهرسٌ تجميعيٌّ للروابط والإحالات إلى مواد قانونية وقضائية منشورة في مصادر خارجية، أُعدّ لتيسير الوصول وخدمة الباحثين والقضاة والمحامين. لا يدّعي ملكية المواد ولا يضمن محتواها أو دقتها أو بقاء روابطها. تبقى الحقوق لأصحابها، ويتحمل المستخدم مسؤولية التحقق من المادة وحقوق استخدامها، ومن له حق أو ملاحظة فليتواصل عبر البريد الإلكتروني. وتشمل مواد المكنز مصادر من دول وأنظمة قانونية متعددة، ولا تدل فهرسة المادة أو إتاحتها على سريانها في المملكة العربية السعودية أو اعتماد مضمونها.
              </DialogDescription>
