...
const MAKANEZ_SOURCES = [
  ...
  { name: "قناة الأنظمة", href: "https://t.me/c/1197187841/1" },
  ...
  { name: "مكتبة الاسكندرية", href: "https://t.me/c/1592768820/1" },
  { name: "مكتبة الباحث العلمي", href: "https://t.me/bahith_pdf" },
  { name: "نواف — المكتبة القانونية للمحامي نواف بن عواض الحربي", href: "https://nawaf-law.com.sa/" },
  { name: "نظام — منصة نظامي للأنظمة السعودية", href: "https://nezams.com/" },
  { name: "قضاء — الجمعية العلمية القضائية", href: "https://qadha.org.sa/ar/books" },
                ...
                if (link.action) {
                  return (
                    <button
                      ...
                      data-share={link.label}
                      className="footer-share-button w-9 h-9 rounded-full text-white flex items-center justify-center hover:opacity-80 transition-opacity"
